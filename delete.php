...
<head>
    ...
    <div class="navBar">
        ...
        <?php
                ...
                $delation_qry = "DELETE FROM train_info WHERE id='{$id}'";

                $response = mysqli_query($db_connection, $delation_qry) or die("Delation Failed");
                ...
                if ($response) {
                    echo ' <div class="alert alert-success alert-dismissible fade show d-flex justify-content-center align-items-center" role="alert">
                            ...
                            <p class="mt-3"><strong>Delation Success! </strong> <a class="btn btn-success" href="trainlist.php" role="button">Go To List</a></p>
